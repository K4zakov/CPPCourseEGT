...
void Shapes::drawPentagone(SDL_Renderer* gameRenderer, int x, int y, int side) {

	const int sides = 5; //5 is to draw a pentagon but we can change it to draw any polygon
